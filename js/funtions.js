					...
					if(hola == null){
						...
						for (var i = 0; i <= Object.keys(hola).length; i++) {
							...
							if (i == 0) {
								...
								input.setAttribute("onclick","getUsuario("+hola[i-1].noAfiliacion+")");
								...
								input.setAttribute("width","30px");
								input.setAttribute("height","30px");
								input.setAttribute("onclick","eliminarUsuario("+hola[i-1].noAfiliacion+")");
								celda.appendChild(input);
								hilera.appendChild(celda);
     ...
     if(ajaxRequest.readyState == 4) {
	     ...
	     var hola = JSON.parse(ajaxRequest.responseText);
			 ...
			 document.getElementById('espacios').innerHTML += "<input id='coloniaUsuario' type='text' placeholder='Colonia' value='"+hola[0].colonia+"'><br>";
		 	 ...
		 	 document.getElementById('espacios').innerHTML += "<button id='reg' onclick = 'modificarUsuario()'>Modificar</button>";
					...
					if(hola == null){
						...
						for (var i = 0; i <= Object.keys(hola).length; i++) {
							...
							if (i == 0) {
								...
								input.setAttribute("width","30px");
								input.setAttribute("height","30px");
								input.setAttribute("onclick","agregarConsultorio("+hola[i-1].idClinica+")");
								celda.appendChild(input);
								hilera.appendChild(celda);
								var celda = document.createElement("td");
								var input = document.createElement("input");
								...
								input.setAttribute("width","30px");
								input.setAttribute("height","30px");
								input.setAttribute("onclick","getClinica("+hola[i-1].idClinica+")");
								celda.appendChild(input);
								hilera.appendChild(celda);
								var celda = document.createElement("td");
								var input = document.createElement("input");
								...
								input.setAttribute("width","30px");
								input.setAttribute("height","30px");
								input.setAttribute("onclick","eliminarClinica("+hola[i-1].idClinica+")");
								celda.appendChild(input);
								hilera.appendChild(celda);
								tblBody.appendChild(hilera);
  ...
  ajaxRequest.onreadystatechange = function() {
     ...
     if(ajaxRequest.readyState == 4) {
	     ...
	     var hola = JSON.parse(ajaxRequest.responseText);
			 ...
			 document.getElementById("barra").innerHTML = "<p>Clinica</p>";
		 	 document.getElementById('espacios').innerHTML = "<input id='nombreClinica' type='text' placeholder='Nombre(s)' value='"+hola[0].nombreClinica+"'>";
		 	 document.getElementById('espacios').innerHTML += "<input id='idClinica' type='number' placeholder='Numero de Clinica'  value='"+hola[0].idClinica+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='telefonoClinica' type='number' placeholder='Telefono' value='"+hola[0].telefono+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='estadoClinica' type='text' placeholder='Querétaro' disabled value='Querétaro' value='"+hola[0].estado+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<select class='' name='' id='municipioClinica' onchange='validarCPUsuario()' ><option value='"+hola[0].municipio+"'>"+hola[0].municipio+"</option><option value='Queretaro'>Querétaro</option><option value='El Márquez'>El Márquez</option><option value='Colón'>Colón</option><option value='Pinal de Amoles'>Pinal de Amoles</option><option value='Jalpan de Serra'>Jalpan de Serra</option><option value='Landa de Matamoros'>Landa de Matamoros</option><option value='Arroyo Seco'>Arroyo Seco</option><option value='Peñamiller'>Peñamiller</option><option value='Cadereyta de Montes'>Cadereyta de Montes</option><option value='San Joaquín'>San Joaquín</option><option value='Tolimán'>Tolimán</option><option value='Ezequiel Montes'>Ezequiel Montes</option><option value='Pedro Escobedo'>Pedro Escobedo</option><option value='Tequisquiapan'>Tequisquiapan</option><option value='San Juan del Río'>San Juan del Río</option><option value='Amealco de Bonfil'>Amealco de Bonfil</option><option value='Corregidora'>Corregidora</option><option value='Huimilpan'>Huimilpan</option><select><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='cpClinica' type='number' placeholder='Codigo Postal' min='76000' max='76998' value='"+hola[0].codPost+"'>";
		 	 document.getElementById('espacios').innerHTML += "<input id='calleClinica' type='text' placeholder='Calle' value='"+hola[0].calle+"'>";
		 	 document.getElementById('espacios').innerHTML += "<input id='numeroClinica' type='number' placeholder='Número' value='"+hola[0].numero+"'>";
			 document.getElementById('espacios').innerHTML += "<input id='coloniaClinica' type='text' placeholder='Colonia' value='"+hola[0].colonia+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='noConsultorios' type='text' placeholder='Numero de consultorios' value='"+hola[0].noConsutorios+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<button id='reg' onclick = 'modificarClinica()'>Modificar</button>";

     }
  }

  var queryString = "?sent=get&valores=" + idClinica;
	//alert(queryString);
  ajaxRequest.open("GET", "api/clinicas/api.php" + queryString, true);
  ajaxRequest.send(null);
...
function modificarClinica() {
	...
	var numeroClinica = document.getElementById('numeroClinica').value;
	var coloniaClinica = document.getElementById('coloniaClinica').value;
	var noConsultorios = document.getElementById('noConsultorios').value;

	if (idClinica !="" && nombreClinica !="" && telefonoClinica !="" && municipioClinica !="" && cpClinica !="" && cpClinica>=document.getElementById('cpClinica').min && cpClinica <= document.getElementById('cpClinica').max && calleClinica !="" && numeroClinica !="" && coloniaClinica !="" && noConsultorios !="") {

	// 	console.log(idClinicaClinica);

		var valores = [idClinica, nombreClinica, estadoClinica, municipioClinica, cpClinica, calleClinica, numeroClinica, coloniaClinica, telefonoClinica, noConsultorios];
		...
		ajaxRequest.onreadystatechange = function() {
			 ...
			 if(ajaxRequest.readyState == 4) {
					if(ajaxRequest.responseText == "Exito xD"){
						alert("Datos del Clinica Modificados");
						window.location.assign("indexAdmin.html");
					}else{
						alert(ajaxRequest.responseText);
					}
...
function eliminarClinica(idClinica) {
  ...
  var queryString = "?sent=del&valores=" + idClinica;
  ajaxRequest.open("GET", "api/Clinicas/api.php" + queryString, true);
  ajaxRequest.send(null);
}

function agregarConsultorio(idClinica) {
	var ajaxRequest;
	...
	ajaxRequest.onreadystatechange = function() {
		 ...
		 if(ajaxRequest.readyState == 4) {
				if(ajaxRequest.responseText == "Exito xD"){
					alert("Consultorio Agregado a la Clinica");
					window.location.assign("indexAdmin.html");
				}else{
					alert(ajaxRequest.responseText);
				}
	...
	var queryString = "?sent=cons&valores=" + idClinica;
	//alert("Clinica: "+queryString);
	ajaxRequest.open("GET", "api/Clinicas/api.php" + queryString, true);
	ajaxRequest.send(null);
}
					...
					if(hola == null){
						...
						for (var i = 0; i <= Object.keys(hola).length; i++) {
							...
							if (i == 0) {
								...
								input.setAttribute("width","30px");
								input.setAttribute("height","30px");
								input.setAttribute("onclick","getDoctor("+hola[i-1].cedulaProfesional+")");
								celda.appendChild(input);
								hilera.appendChild(celda);
								var celda = document.createElement("td");
								var input = document.createElement("input");
								...
								input.setAttribute("width","30px");
								input.setAttribute("height","30px");
								input.setAttribute("onclick","eliminarDoctor("+hola[i-1].cedulaProfesional+")");
								celda.appendChild(input);
								hilera.appendChild(celda);
...
function getDoctor(cedulaProfesional) {
	var ajaxRequest;
  ...
  ajaxRequest.onreadystatechange = function() {
     ...
     if(ajaxRequest.readyState == 4) {
	     ...
	     var hola = JSON.parse(ajaxRequest.responseText);
			 ...
			 document.getElementById("barra").innerHTML = "<p>Doctores</p>";
		 	 document.getElementById('espacios').innerHTML = "<input id='nombreDoctor' type='text' placeholder='Nombre(s)' value='"+hola[0].nombre+"'>";
		 	 document.getElementById('espacios').innerHTML += "<input id='apellidosDoctor' type='text' placeholder='Apellidos' value='"+hola[0].apellidos+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='cedulaProfesional' type='number' placeholder='Cedula Profesional' disabled value='"+hola[0].cedulaProfesional+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='correoDoctor' type='email' placeholder='Correo' value='"+hola[0].email+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='telefonoDoctor' type='number' placeholder='Telefono' value='"+hola[0].telefono+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='estadoDoctor' type='text' placeholder='Querétaro' disabled value='Querétaro' value='"+hola[0].estado+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<select class='' name='' id='municipioDoctor' onchange='validarCPUsuario()' ><option value='"+hola[0].municipio+"'>"+hola[0].municipio+"</option><option value='Queretaro'>Querétaro</option><option value='El Márquez'>El Márquez</option><option value='Colón'>Colón</option><option value='Pinal de Amoles'>Pinal de Amoles</option><option value='Jalpan de Serra'>Jalpan de Serra</option><option value='Landa de Matamoros'>Landa de Matamoros</option><option value='Arroyo Seco'>Arroyo Seco</option><option value='Peñamiller'>Peñamiller</option><option value='Cadereyta de Montes'>Cadereyta de Montes</option><option value='San Joaquín'>San Joaquín</option><option value='Tolimán'>Tolimán</option><option value='Ezequiel Montes'>Ezequiel Montes</option><option value='Pedro Escobedo'>Pedro Escobedo</option><option value='Tequisquiapan'>Tequisquiapan</option><option value='San Juan del Río'>San Juan del Río</option><option value='Amealco de Bonfil'>Amealco de Bonfil</option><option value='Corregidora'>Corregidora</option><option value='Huimilpan'>Huimilpan</option><select><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='cpDoctor' type='number' placeholder='Codigo Postal' min='76000' max='76998' value='"+hola[0].codPost+"'>";
		 	 document.getElementById('espacios').innerHTML += "<input id='calleDoctor' type='text' placeholder='Calle' value='"+hola[0].calle+"'>";
		 	 document.getElementById('espacios').innerHTML += "<input id='numeroDoctor' type='number' placeholder='Número' value='"+hola[0].numero+"'>";
			 document.getElementById('espacios').innerHTML += "<input id='coloniaDoctor' type='text' placeholder='Colonia' value='"+hola[0].colonia+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<input id='idClinicaDoctor' type='text' placeholder='Numero de Clinica' value='"+hola[0].idClinica+"'><br>";
		 	 document.getElementById('espacios').innerHTML += "<button id='reg' onclick = 'modificarDoctor()'>Modificar</button>";

     }
  }

  var queryString = "?sent=get&valores=" + cedulaProfesional;
	alert(queryString);
  ajaxRequest.open("GET", "api/doctores/api.php" + queryString, true);
  ajaxRequest.send(null);
...
function modificarDoctor() {
	var nombreDoctor = document.getElementById('nombreDoctor').value;
	var apellidosDoctor = document.getElementById('apellidosDoctor').value;
	var cedulaProfesional = document.getElementById('cedulaProfesional').value;
	var correoDoctor = document.getElementById('correoDoctor').value;
	var telefonoDoctor = document.getElementById('telefonoDoctor').value;
	var estadoDoctor = document.getElementById('estadoDoctor').value;
	var municipioDoctor = document.getElementById('municipioDoctor').value;
	...
	var numeroDoctor = document.getElementById('numeroDoctor').value;
	var coloniaDoctor = document.getElementById('coloniaDoctor').value;
	var idClinicaDoctor = document.getElementById('idClinicaDoctor').value;

	if (nombreDoctor !="" && apellidosDoctor !="" && cedulaProfesional !="" && correoDoctor !="" && telefonoDoctor !=""  && municipioDoctor !="" && cpDoctor !="" && cpDoctor>=document.getElementById('cpDoctor').min && cpDoctor <= document.getElementById('cpDoctor').max && calleDoctor !="" && numeroDoctor !="" && coloniaDoctor !="" && idClinicaDoctor !="") {

	// 	console.log(idClinicaDoctor);

		var valores = [nombreDoctor, apellidosDoctor, cedulaProfesional, correoDoctor,telefonoDoctor, estadoDoctor, municipioDoctor, cpDoctor, calleDoctor, numeroDoctor, coloniaDoctor, idClinicaDoctor];
		...
		ajaxRequest.onreadystatechange = function() {
			 ...
			 if(ajaxRequest.readyState == 4) {
					if(ajaxRequest.responseText == "Exito xD"){
						alert("Datos del Doctor Modificados");
						window.location.assign("indexAdmin.html");
					}else{
						alert(ajaxRequest.responseText);
					}
...
function eliminarDoctor(cedulaProfesional) {
	var ajaxRequest;
  ...
  var queryString = "?sent=del&valores=" + cedulaProfesional;
  ajaxRequest.open("GET", "api/doctores/api.php" + queryString, true);
  ajaxRequest.send(null);
}
